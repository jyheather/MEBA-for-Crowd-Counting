...
def parse_args():
    ...
    parser.add_argument('--save-dir', default='/content/drive/MyDrive/Bayesian-Crowd-Counting-master-sha/result',
    ...
    parser.add_argument('--background-ratio', type=float, default=1.2,
