...
def generate_data(im_path):
    ...
    # points = loadmat(mat_path)['annPoint'].astype(np.float32)    
    mat_path = im_path.replace('.jpg', '.mat')
    mat_path = mat_path.replace('IMG', 'GT_IMG')
...
def parse_args():
    ...
    parser.add_argument('--origin-dir', default='/content/drive/MyDrive/ShanghaiTech/part_A',
